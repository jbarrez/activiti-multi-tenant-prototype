 ...
 * @author Joram Barrez
 */
public class DeprecateMultiTenantProcessEngineConfiguration extends ProcessEngineConfigurationImpl {
  
  private static final Logger logger = LoggerFactory.getLogger(DeprecateMultiTenantProcessEngineConfiguration.class);
  ...
  public DeprecateMultiTenantProcessEngineConfiguration() {
